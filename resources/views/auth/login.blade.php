        ...
        <div class="wrap">
            <section class="panel left">
                <div class="left-inner">
                    ...
                    <div class="benefits">
                        <div class="benefit"><i class="fas fa-check-circle"></i> Guardá vehículos y preferencias</div>
                        <div class="benefit"><i class="fas fa-bell"></i> Recibí avisos de nuevos anuncios</div>
                        <div class="benefit"><i class="fas fa-user-shield"></i> Acceso a panel y configuraciones</div>
                    </div>
                </div>
            </section>
            ...
            <section class="panel right">
                ...
                <form action="#" method="POST">
                    ...
                    <div class="row">
                        ...
                        <a class="link" href="/forgot-password">Olvidé mi contraseña</a>
                    </div>
                    ...
                    <div class="note">
                        ...
                        <div>
                            Si todavía no tenés cuenta, creala desde <a class="link" href="/register">Registrarse</a>.
                        </div>
                    </div>
                </form>
            </section>
